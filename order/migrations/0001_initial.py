...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('goods', '0005_auto_20180705_2049'),
        ('address', '0002_auto_20180703_2011'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.SmallIntegerField(default=1, verbose_name='订单状态', choices=[(1, '待支付'), (2, '代发货'), (3, '待收货'), (4, '待评价'), (5, '已完成')])),
                ('addr', models.ForeignKey(to='address.Address', verbose_name='地址')),
